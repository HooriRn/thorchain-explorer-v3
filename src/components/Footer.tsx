...
const Footer: React.FC<FooterProps> = ({ currentBlock = 0 }) => {
  ...
  return (
    <div className={styles.footer}>
      <div className={styles.footerContainer}>
        ...
        <div className={styles.footerText}>
          <div className={`${styles.blockHeight} ${isAnimating ? styles.animate : ''}`}>
            <small style={{ color: 'var(--primary-color)' }} className={`mono ${styles.value}`}>
              <BlockIcon className={styles.blockIcon} width={12} height={12} fill="currentColor" />
